...
{
    public class BannerClient : global::UnityEngine.AndroidJavaProxy, global::GoogleMobileAds.Common.IBannerClient
    {
        ...
        protected internal BannerClient(string className) : base((string)null)
        {
        }

        public BannerClient() : base((string)null)
        {
        }
