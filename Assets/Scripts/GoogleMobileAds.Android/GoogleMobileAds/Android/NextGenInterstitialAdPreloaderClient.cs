...
{
    public class NextGenInterstitialAdPreloaderClient : global::UnityEngine.AndroidJavaProxy, global::GoogleMobileAds.Common.IInterstitialAdPreloaderClient
    {
        private readonly global::UnityEngine.AndroidJavaObject _unityInterstitialAdPreloader;
        ...
        public NextGenInterstitialAdPreloaderClient() : base((string)null)
        {
        }
        ...
        public global::GoogleMobileAds.Common.IInterstitialClient DequeueAd(string preloadId)
        {
            return null;
        }
