namespace UnityEngine.InputSystem.Utilities
{
    internal static class ArrayHelpers
    {
        ...
        public static bool ContainsReference<TFirst, TSecond>(this TFirst[] array, int count, TSecond value)
            where TFirst : TSecond where TSecond : class
        {
            return false;
        }
        ...
        public static void Resize<TValue>(ref global::Unity.Collections.NativeArray<TValue> array, int newSize, global::Unity.Collections.Allocator allocator)
            where TValue : struct
        {
        }
        ...
        public static int AppendListWithCapacity<TValue, TValues>(ref TValue[] array, ref int length, TValues values, int capacityIncrement = 10)
            where TValues : global::System.Collections.Generic.IReadOnlyList<TValue>
        {
            return 0;
        }

        public static int AppendWithCapacity<TValue>(ref global::Unity.Collections.NativeArray<TValue> array, ref int count, TValue value, int capacityIncrement = 10, global::Unity.Collections.Allocator allocator = global::Unity.Collections.Allocator.Persistent)
            where TValue : struct
        {
            return 0;
        }
        ...
        public static int GrowBy<TValue>(ref global::Unity.Collections.NativeArray<TValue> array, int count, global::Unity.Collections.Allocator allocator = global::Unity.Collections.Allocator.Persistent)
            where TValue : struct
        {
            return 0;
        }
        ...
        public static int GrowWithCapacity<TValue>(ref global::Unity.Collections.NativeArray<TValue> array, ref int count, int growBy, int capacityIncrement = 10, global::Unity.Collections.Allocator allocator = global::Unity.Collections.Allocator.Persistent)
            where TValue : struct
        {
            return 0;
        }
        ...
        public static TValue[] Merge<TValue>(TValue[] first, TValue[] second)
            where TValue : global::System.IEquatable<TValue>
        {
            return null;
        }
        ...
        public static void EraseAtWithCapacity<TValue>(global::Unity.Collections.NativeArray<TValue> array, ref int count, int index)
            where TValue : struct
        {
        }
        ...
        public static TValue[] Clone<TValue>(TValue[] array)
            where TValue : global::System.ICloneable
        {
            return null;
        }
        ...
        public static void SwapElements<TValue>(this global::Unity.Collections.NativeArray<TValue> array, int index1, int index2)
            where TValue : struct
        {
        }
    }
