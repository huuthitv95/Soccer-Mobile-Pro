...
**Mốc lập kế hoạch:** 11/09/2026 · **Cập nhật tiến độ:** 12/09/2026 (P1-06 batch B1–B2 domain) · **Baseline code:** `c579b71` (main) · **Unity:** 2022.3.62f3 · **Chủ sở hữu file:** Product + Tech Lead
...
- [~] P1-06 Mở rộng domain theo FC Online M: Team Color/chemistry, lương đội hình (salary cap), nâng cấp +1…+10 với tỷ lệ công bố, huấn luyện (training points), mùa thẻ (season/class), squad definition/validator. Kế hoạch: [p1-06 plan](docs/implementation/p1-06-squad-rules-and-card-tiers-plan.md); tiến độ: **B1 + B2 xong** ở mức domain (contract, rule set fixture versioned, snapshot N=3, salary/Team Color calculator, squad validator, squad repository — 44 test domain pass, [nhật ký](docs/implementation/p1-06-squad-rules-and-card-tiers-implementation.md)); còn B2b (state `InSquad` cùng transaction), B3 nâng cấp bậc, B4 huấn luyện, B5 projection/PlayMode, B6 docs, và **phải chạy lại Unity Test Runner**. HLV card chuyển sang P5-02.
