...
| FOM-D02 | Tham số Team Color và lương đội hình phiên bản 1 | Product + Gameplay | FOM-Q04/Q05; scenario balance | `TestReady` (P1-06 B1–B2: rule set fixture versioned + automated test cho cả hai scope đếm và hành vi vượt cap) |
